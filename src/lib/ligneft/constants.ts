export const ACTIVE_FILE_PATH = "src/data/ligneFT.normalized.ts";

export const ACTIVE_JSON_FILE_PATH = "src/data/ligneFT.normalized.json";

export const LIM2_ACTIVE_FILE_PATH = "src/data/normalized/ligneFT.normalized.ts";
...
export const ARCHIVE_FILE_PREFIX = "ligneFT.normalized.";
