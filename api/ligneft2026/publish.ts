import { publish2026NormalizedData } from "../../src/lib/ligneft2026/publish.js";
import {
...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    const diagnostic = await publish2026NormalizedData(body.data);

    return jsonResponse({ ok: true, diagnostic });
  } catch (error) {
