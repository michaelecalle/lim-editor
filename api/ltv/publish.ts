import { publishLtvNormalizedData } from "../../src/lib/ligneft/ltvArchive.js";
import {
...
function jsonResponse(
  body: LtvPublishResponse | LtvErrorResponse,
  status = 200
): Response {
...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    const diagnostic = await publishLtvNormalizedData(body.data);
